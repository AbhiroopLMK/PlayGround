...
/// <summary>
/// Demo command: host selects which domain event to publish; <see cref="PublishDomainEventHandler"/> maps to
/// sample <see cref="BrighterEventing.Sample.DomainEvents.OrderCreatedEvent"/> / OrderUpdated / OrderCancelled and
/// posts with optional <see cref="PublishRoutingKey"/>.
/// </summary>
