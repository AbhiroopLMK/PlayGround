...
using BrighterEventing.Publisher.Net6.Cosmos.Configuration;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Logging;
using Paramore.Brighter;

namespace BrighterEventing.Publisher.Net6.Cosmos;
...
public class PublisherHostedService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _logger.LogInformation(
            "Net6 Cosmos publisher started. Transport={Transport}, Interval={Interval}s",
            transport,
            intervalSeconds);
